...
<form method="POST" th:object="${student}" action="DPS/school/registration/process_TeacherRegistration">
<table align="center" cellpadding = "10"> 
    ...
    <tr>
        <td>Subject</td>
        <td><input type="text" name="subject" maxlength="30" placeholder="Enter your last name" required field="*{DateOfBirthf}" minlength="1"/>
        </td>
        </tr>
    ...
    <tr>
        ...
        <tr>
            ...
            <tr>
            <td>Pin Code</td>
            <td><input type="text" name="Pin_Code" maxlength="6" placeholder="Enter your current area code"/>
            </td>
            </tr>
